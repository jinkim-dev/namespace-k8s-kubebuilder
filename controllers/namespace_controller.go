...
func (r *NamespaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	const injectKey = "deploy-inject"

	// 1. read "deploy-inject" annotation
	injectValueInNs := instance.Annotations[injectKey]
	...
	if err := r.List(context.TODO(), deployments, client.InNamespace(req.Name)); err != nil {
		logger.Error(err, "unable to list deployment")
		return ctrl.Result{}, err
	}
